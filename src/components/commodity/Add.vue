<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/goods' }">商品分类</el-breadcrumb-item>
      ...
      <!-- tab侧边栏区域 -->
        <el-tabs :tab-position="'left'" v-model="activeIndex" :before-leave="beforeTableave" @tab-click="tabClicked">
          ...
          <el-tab-pane label="商品图片" name="3">
            <!-- action表示图片要上传到的api地址，在补上路径 -->
            <!-- on-preview点击图片名字的预览事件 -->
            <!-- on-remove点击叉号的删除事件 -->
            <!-- list-type决定图片选中的显示效果 -->
            <!-- headers设置上传的请求头部 -->
            <el-upload
              :action="uploadURL"
...
export default {
  ...
  methods: {
    ...
    handleRemove (file) {
      ...
      // 从pics数组中，找到这个对应的索引值 x代表数组里的每一项
    ...
    // 监听图片上传成功的事件,response服务器返回的数据对象
    ...
    add () {
      ...
      this.$refs.addFormRef.validate(async valid => {
        ...
        // lodash cloneDeep(obj) 深拷贝,复制出新的一份对象
